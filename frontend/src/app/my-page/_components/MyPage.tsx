...
const MyPage = () => {
  ...
  return (
    <div className="h-screen flex flex-col items-center">
      ...
      <h2 className="w-[36.25rem] h-[3.75rem] border-gray-200 text-[1.75rem] mt-5 mb-3">{name}님</h2>
      <Link
        href={"/my-page/edit/email"}
        className="w-[36.25rem] h-[3.75rem] flex justify-between items-center text-[1.25rem] mb-4 p-3 cursor-pointer hover:bg-gray-100 duration-200 rounded-sm"
      >
